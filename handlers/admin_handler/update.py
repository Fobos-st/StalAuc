...
Всем привет и сегодня я с отличными новостями!

Обновление базы данных, но увы всё так-же без ряда важных предметов(

В новом обновление я исправил наконец-то баги клавиатуры ПДА,
надеюсь новый опыт работы будет без старых или новых проблем!

А так-же розыгрыш БП, условия просты просто принять участие нажав на кнопку 
'Участие в розыгрыше', и ввести свой ник на RU сервере!

Итоги я подведу 29числа!
