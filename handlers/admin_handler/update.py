...
Бот работает в стандартном режиме, с момента отправки сообщения возможны ближайшие пару часов перебои в работе бота со стороны хостинга

подробнее об обновление - https://telegra.ph/S-nastupayushchej-zimoj-11-30
""")
